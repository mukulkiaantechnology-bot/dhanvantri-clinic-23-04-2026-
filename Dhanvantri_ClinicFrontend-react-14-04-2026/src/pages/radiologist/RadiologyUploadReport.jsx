    ...
    return (<div className="dashboard-container fade-in">
            ...
            <div className="content-section mt-xl">
                ...
                return (<tr key={order.id}>
                                                ...
                                                <td>
                                                    <button type="button" className="btn btn-upload-report btn-sm btn-with-icon" onClick={() => handleOpenUpload(order)} disabled={!isCollected && !isPaidStatus} title={!isPaidStatus ? "Payment required" : ""}>
