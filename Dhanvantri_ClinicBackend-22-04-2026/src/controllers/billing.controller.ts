...
export const getCorporatePharmacySummary = asyncHandler(async (req: AuthRequest, res: Response) => {
    const summary = await billingService.getCorporatePharmacySummary(req.clinicId!, String(req.query.month || ''));
